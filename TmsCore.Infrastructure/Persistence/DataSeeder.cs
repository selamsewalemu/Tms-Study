...
// Module 6 Exercise 4 setup: Provide deterministic, idempotent Development data.
public static class DataSeeder
{
	// Question 1: Keep the same 25 course rows on every Development machine.
	...
	public static async Task SeedAsync(TmsDbContext context, CancellationToken ct = default)
	{
		...
		// Question 3: Insert each deterministic course and save the complete batch once.
		foreach ((string code, string title, int maxCapacity) in Courses)
		{
